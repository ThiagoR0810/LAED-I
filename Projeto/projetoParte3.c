...
int verificaObstaculo(TipoLista Lista)
{
        ...
        if (verifica->Item.TipoSegmento == 1)
        {
            if (verifica->Prox != NULL && verifica->Prox->Item.TipoSegmento == 3)
            {
                if (verifica->Prox->Prox->Item.TipoSegmento == 2)
                {
                    while (verifica != NULL)
                    {
                        if (verifica->Prox->Prox->Prox->Item.TipoSegmento != 9)
                        {
                            if (verifica->Prox->Prox->Prox != NULL && verifica->Prox->Prox->Prox->Item.TipoSegmento == 2)
                            {
                                if (verifica->Prox->Prox->Prox->Prox != NULL && verifica->Prox->Prox->Prox->Prox->Item.TipoSegmento == 3)
                                {
                                    if (verifica->Prox->Prox->Prox->Prox->Prox != NULL && verifica->Prox->Prox->Prox->Prox->Prox->Item.TipoSegmento == 1)
                                    {
                                        return 1;
                                    }
                                }
...
int main()
{
    ...
    // inicia as matrizes com zero // VALOR ZERO PODE IGNORAR
    for (int i = 0; i < L; i++)
    {
    ...
    int tam = (L * maior) + L; // + L insere as quebras de linha usando valor 9
    ...
    int result = verificaObstaculo(lista);
    // printf("%d ", result);
